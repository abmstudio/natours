...
/* eslint-disable */
var displayMap = function displayMap(locations, settings) {
  // Mapbox init
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWJtc3R1ZGlvIiwiYSI6ImNrNXI1bnI1cjA4dzUzZG1yZHdtaHVlY2wifQ.Wy8J5ftzHDkoUj3Gb5qGqA';
  var map = new mapboxgl.Map(Object.assign({
    container: 'map',
    style: 'mapbox://styles/abmstudio/ck5r5zlbt17to1il30e9wzknj',
    scrollZoom: false // center: [-74.5, 40],
    // zoom: 10
...
var stripe = Stripe('pk_test_VSGD2e5TRyfi0u5BHgZaEnPQ00ljc915OB');
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  if (mapBox) {
    ...
    var settings = JSON.parse(mapBox.dataset.options);
    (0, _mapbox.displayMap)(locations, settings);
  }
  ...
  if (userDataForm) {
    var elemUpload = userDataForm.querySelector('.form__upload');
    var elemUserPhoto = userDataForm.querySelector('.form__user-photo');
    elemUpload.addEventListener('change', function (e) {
      var file = userDataForm.getElementById('photo').files[0];
      ...
      regeneratorRuntime.mark(function _callee(e) {
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                e.preventDefault(); // 202. Adding Image Upload to Form
